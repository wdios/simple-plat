...
public class SimpleSession implements ValidatingSession, Serializable {
    ...
    public static final int USER_ID_BIT_MASK = 1 << bitIndexCounter++;
    public static final int USER_AGENT_BIT_MASK = 1 << bitIndexCounter++;
    public static final int STATUS_BIT_MASK = 1 << bitIndexCounter++;
    public static final int USERNAME_BIT_MASK = 1 << bitIndexCounter++;
    public static final int REMEMBER_ME_BIT_MASK = 1 << bitIndexCounter++;
