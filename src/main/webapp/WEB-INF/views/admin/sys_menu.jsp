...
<html>
  <head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0" />
		...
		<link rel="stylesheet" href="${path}/resources/js/ace-master/assets/css/jquery-ui.min.css" />
		<link rel="stylesheet" href="${path}/resources/js/ace-master/assets/css/bootstrap-datepicker3.min.css" />
		<link rel="stylesheet" href="${path}/resources/js/ace-master/assets/css/ui.jqgrid.min.css" />
...
<![endif]-->
    <script type="text/javascript">
		...
		<script src="${path}/resources/js/ace-master/assets/js/bootstrap-datepicker.min.js"></script>
		<script src="${path}/resources/js/ace-master/assets/js/jquery.jqGrid.min.js"></script>
		<script src="${path}/resources/js/ace-master/assets/js/grid.locale-en.js"></script>
    ...
    <script type="text/javascript">
      ...
      function setActive() {
        ...
        $("[menucode='sysMenu']").addClass("active");
      }
